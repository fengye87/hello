...
func (c *helloClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetReply, error) {
	out := new(GreetReply)
	err := c.cc.Invoke(ctx, "/fengye87.hello.v1alpha1.Hello/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServer) Greet(context.Context, *GreetRequest) (*GreetReply, error) {
...
func _Hello_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fengye87.hello.v1alpha1.Hello/Greet",
	}
...
var Hello_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fengye87.hello.v1alpha1.Hello",
